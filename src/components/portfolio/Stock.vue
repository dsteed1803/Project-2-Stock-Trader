        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    <!--ToDo: Inside <small> tags display Price: stock.price | Quantity stock.quantity ***DONE ALL****-->
                </h3>
            </div>
            <div class="panel-body">
                ...
                <div class="pull-right">
                    ...
                    <button @click="sellStock" :disabled="insufficientQuantity || quantity <= 0 || !Number.isInteger(quantity)" class="btn btn-success">
